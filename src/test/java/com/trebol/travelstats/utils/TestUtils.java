...
//
    ...
    public static FlightDTO createBCNToJFKFlightDTO() {
        return new FlightDTO(1L, createBCNAirportDTO(), createJFKAirportDTO(), createAACarrierDTO(), "15-08-1996", 7000, "08:00:00", "AA23");
    }

    public static FlightDTO createJFKToBCNFlightDTO() {
        return new FlightDTO(2L, createJFKAirportDTO(), createBCNAirportDTO(), createQantasCarrierDTO(), "23-08-1996", 7100, "08:30:00", "QF543");
    }
