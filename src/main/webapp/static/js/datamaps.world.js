(function() {
  ...
  var defaultOptions = {
    ...
    geographyConfig: {
        ...
        highlightFillColor: '#6d9fdc',
        highlightBorderColor: '#3177CC',
    ...
    bubblesConfig: {
        borderWidth: 2,
        borderColor: 'rgba(184,33,58, 1.0)',
        popupOnHover: true,
        popupTemplate: function(geography, data) {
    ...
    arcs
      .enter()
        ...
        .attr('d', function(datum) {
			...
			var originX = originXY[0];
			var originY = originXY[1];

			var destinationX = destXY[0];
			var destinationY = destXY[1];

			var dx = destinationX - originX,
				dy = destinationY - originY,
				dr = Math.sqrt(dx * dx + dy * dy);
			return "M" + originX + "," + originY + "A" + dr + "," + dr + " 0 0,1 " + destinationX + "," + destinationY;
        ...
        .attr('id', function(datum) {
			return 'datamaps-arc-' + datum.flightYear;
		})
        .transition()
          .delay(100)
          .style('fill', function() {
            ...
            */
            ...
            this.style.strokeDasharray = '0,1 5';//length + ' ' + length;
    ...
    bubbles
      .enter()
        ...
        .style('fill', function ( datum ) {
          ...
          return fillColor || fillData.defaultFill;*/
			var fillColor = datum.color;
			return fillColor || 'rgba(184,33,58, 0.75)';
        })
        ...
        .on('mouseout', function ( datum ) {
          ...
          if (options.highlightOnHover) {
            //reapply previous attributeshttps://lh3.googleusercontent.com/-PTcMZ-vdtDE/AAAAAAAAAAI/AAAAAAAAAWo/G_L85Ag4rLg/s46-c-k-no/photo.jpg
            var previousAttributes = JSON.parse( $this.attr('data-previousAttributes') );
            for ( var attr in previousAttributes ) {
              $this.style(attr, previousAttributes[attr]);
            }
