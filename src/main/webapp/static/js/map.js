...
function getData() {
    ...
    $.each(countries, function (i, country) {
        values[country] = {fillKey: country};
    });
    return values;
}
...
function createBubbles(map, latOrigin, lngOrigin, latDestination, lngDestination) {
    ...
    var bubbleDestination = {
        name: "",
        radius: BUBBLE_RADIUS,
        color: BUBBLE_COLOR_DESTINATION,
        latitude: latDestination,
        longitude: lngDestination
    };

    var bubblePointOrigin = {
        name: "",
        radius: 3,
        color: BUBBLE_COLOR_POINT,
        borderColor: BUBBLE_COLOR_POINT,
        latitude: latOrigin,
        longitude: lngOrigin
    };
    var bubblePointDestination = {
        name: "",
        radius: 3,
        color: BUBBLE_COLOR_POINT,
        borderColor: BUBBLE_COLOR_POINT,
